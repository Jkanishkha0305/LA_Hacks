...
export async function POST(req: Request) {
  ...
  imageContent.push({
    type: 'text' as const,
    text: `You are a senior NYC real estate development analyst. Compare these ${parcels.length} development sites and produce a structured comparative analysis.
