...
/**
 * DECK/01 tactical LA map. Dark Carto tiles + amber DivIcon markers.
 * Renders a marker for every camera with valid coordinates and fires
 * `onSelect` when the operator clicks one.
 */

interface LaMapProps {
  cameras: CaltransCamera[];
  selectedId?: string | null;
  onSelect: (camera: CaltransCamera) => void;
}

// Downtown LA centroid — good default view for LA camera coverage.
...
export default function LaMap({ cameras, selectedId, onSelect }: LaMapProps) {
